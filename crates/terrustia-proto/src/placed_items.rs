...
//!
//! The game answers it in three places, and this holds all three:
//!
...
//! source it comes from. Said plainly because this comment used to open with the word GENERATED,
